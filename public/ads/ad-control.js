...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const currentSlug = pathSegments[pathSegments.length - 1] || 'homepage';
    
    // 2. Fire the renderAdvertisement function from your ad-engine script
    if (typeof renderAdvertisement === 'function') {
        renderAdvertisement(adConfig, currentSlug);
    } else {
        console.error("Ad Engine Error: 'renderAdvertisement' function could not be found. Check script loading order.");
    }
});
